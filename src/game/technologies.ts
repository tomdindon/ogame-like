...
export const TECHNOLOGIES: TechDef[] = [
  ...
  { id: "tech16", nom: "Canon plasma", desc: "Augmente la puissance d'attaque de l'unité.", maxLevel: 10, baseCost: { energy: 1200, nano: 600, data: 300, aiFragment: 50 }, baseTime: 70, effect: "unlock_next_level", prereq: { tech15: 5, tech7: 4, tech1: 10 } },
