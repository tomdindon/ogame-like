...
export const MISSIONS: Record<string, MissionDef> = {
  ...
  key: "patrouille_perimetrique", name: "Patrouille du périmètre", duration: 600, reward: { scrap: 8000, xp: 40 }, prereq: { roquette: 30 } },
  verrouillage_radar: { key: "verrouillage_radar", name: "Alerte invasion", duration: 1200, reward: { energy: 6000, xp: 90 }, prereq: { batterie_aa: 20, intercepteur: 10 } },
  suppression_blindee: { key: "suppression_blindee", name: "Repli des envahisseurs", duration: 1800, reward: { reinforcedSteel: 200, xp: 160 }, prereq: { canon_impulsion: 25, roquette: 50 } },
  bombardement_orbital: { key: "bombardement_orbital", name: "Siège repoussé", duration: 2700, reward: { scrap: 45000, cyberModule: 350, xp: 220 }, prereq: { canon_plasma: 50, canon_impulsion: 65 } },
  interception_prioritaire: { key: "interception_prioritaire", name: "Dernier bastion", duration: 3600, reward: { syntheticNanites: 400, aiFragment: 650, xp: 380 }, prereq: { intercepteur: 60, batterie_aa: 70 },
},
};
